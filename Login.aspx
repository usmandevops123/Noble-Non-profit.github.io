<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Serving_Hands.WebForm2" %>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12"></div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    ...
                    <form class="form-container">                        
                      <div class="form-group" style="padding-top: 159px">
                        <h1 style="color: rgb(96,188,15);">Login Form</h1>
                      ...
                      <div class="form-group">
                        <label><a href="ForgetPassword.aspx">Forget Password</a></label>
                      </div>
                        <asp:Button ID="Button1" runat="server" Text="Login" OnClick="Button1_Click" class="btn btn-success btn-block btn-css"/>
