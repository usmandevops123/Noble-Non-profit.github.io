<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="Serving_Hands.AdminPage" %>
...
<body>
			...
			<div class="container">
				<nav class="navbar navbar-expand-lg navbar-light">
					<div class="container">
						...
						<a class="navbar-brand logo_h" href="AdminPage.aspx"><img src="img/logo.png" alt=""></a>
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								<li class="nav-item active"><a class="nav-link" href="AdminPage.aspx">Home</a></li>  
                                    <li class="nav-item submenu dropdown">
									<a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Edit Donations</a>
									<ul class="dropdown-menu">
										<li class="nav-item"><a class="nav-link" href="money.aspx">Money</a></li>
										<li class="nav-item"><a class="nav-link" href="Dowry.aspx">Dowery</a></li>
										<li class="nav-item"><a class="nav-link" href="clothes.aspx">Clothes</a></li>
                                        <li class="nav-item"><a class="nav-link" href="Blood.aspx">Blood</a></li>
									</ul>
								</li>
                                <li class="nav-item"><a class="nav-link" href="AdminSignUp.aspx">New Admin</a></li>
                                <li class="nav-item"><a class="nav-link" href="Donation.aspx">Users</a></li>
                                <li class="nav-item"><a class="nav-link" href="userview.aspx">Donations</a></li>
                                <li class="nav-item"><a class="nav-link" href="comment.aspx">Comments</a></li>
	...
	Welcome Admin <b><asp:Label ID="Label1" runat="server" Text="Label"></asp:Label></b>
	<!--================ Start Causes Area =================-->
