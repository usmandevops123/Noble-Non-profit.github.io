<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdminSignUp.aspx.cs" Inherits="Serving_Hands.AdminSignUp" %>
            ...
            <div class="col-md-4 col-sm-4 col-xs=12"></div>
                <div class="col-md-4 col-sm-4 col-xs-12">
                    ...
                    <form class="form-container">
                           ...
                           <h2 style="color: rgb(96,188,15);padding-top: 100px">Signup as Admin</h2>
                           <div class="form-group">
                               <label class="exampleInputText">Admin Name</label>
                      ...
                      <asp:Button ID="Button1" runat="server" class="btn btn-success btn-block btn-css" Text="SignupAdmin" OnClick="Button1_Click"/>
