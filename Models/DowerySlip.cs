...
{
    public class DowerySlip:ICrud<DowerySlip>
    {
        ...
        public void Add(DowerySlip s)
        {
            throw new NotImplementedException();
        }

        public void Delete(DowerySlip s)
        {
            throw new NotImplementedException();
        }

        public List<DowerySlip> GetIds()
        {
            throw new NotImplementedException();
        }

        public List<DowerySlip> GetOrganization()
        {
            List<DowerySlip> a = new List<DowerySlip>();
            string query = "select nameOrganization from Organization";
            SqlCommand com = new SqlCommand(query, con.GetConnection());
            SqlDataReader rd = com.ExecuteReader();
            while (rd.Read())
            {
                DowerySlip b = new DowerySlip();
        ...
        public StringReader Recipt(DowerySlip a)
        {
            string Name = "Raza";
            ...
            dt.Columns.AddRange(new DataColumn[5] {
                            new DataColumn("Furniture", typeof(string)),
                            new DataColumn("Applinces", typeof(string)),
                            new DataColumn("Crockeries", typeof(string)),
                            new DataColumn("Organization", typeof(string)),
                            new DataColumn("Date Of Donation", typeof(string)),
                            });
            dt.Rows.Add(a.furniture,a.appliances,a.crokries, a.Organization, a.date);
        ...
        public DowerySlip Search(DowerySlip s)
        {
            throw new NotImplementedException();
        }

        public void Update(DowerySlip s)
        {
            throw new NotImplementedException();
        }
    }
