...
{
    public class MoneySlip:ICrud<MoneySlip>
    {
        ...
        public void Add(MoneySlip s)
        {
            throw new NotImplementedException();
        }

        public void Delete(MoneySlip s)
        {
            throw new NotImplementedException();
        }

        public List<MoneySlip> GetIds()
        {
            throw new NotImplementedException();
        }

        public List<MoneySlip> GetOrganization()
        {
            List<MoneySlip> a = new List<MoneySlip>();
            string query = "select nameOrganization from Organization";
            SqlCommand com = new SqlCommand(query, con.GetConnection());
            SqlDataReader rd = com.ExecuteReader();
            while (rd.Read())
            {
                MoneySlip b = new MoneySlip();
        ...
        public StringReader Recipt(MoneySlip a)
        {
            string Name = "Raza";
            ...
            dt.Rows.Add(a.amount, a.Organization, a.date);
        ...
        public MoneySlip Search(MoneySlip s)
        {
            throw new NotImplementedException();
        }

        public void Update(MoneySlip s)
        {
            throw new NotImplementedException();
        }
    }
